                                        ...
                                        <tbody>
                                            <tr>
                                                <td align="center" style="padding: 30px 56px 28px 56px;" valign="top">
                                                    <a style="color: #3498DB; text-decoration: none;"><img style="width: 30%; border: 0;" alt="New inquery request" src="{{URL::asset('frontend/assets/img/logo-new.png')}}">
                                                    </a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0 56px 15px 56px;" valign="top">
                                                    <div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 20px; color: #333;"><strong>You have recived a new inquery request</strong> </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0 56px 28px 56px;" valign="top">
                                                    <div style="width:100%;font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 15px; color: #333;"><strong>User name : </strong></div>
                                                  <div style="width:100%;font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 15px; color: #333;">{{$caseData['name']}}</div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0 56px 28px 56px;" valign="top">
                                                  ...
                                                  <div style="width:100%;font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 15px; color: #333;">{{$caseData['subject']}}</div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0 56px 28px 56px;" valign="top">
                                                    <div style="width:100%;font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 15px; color: #333;"><strong>Message : </strong></div>
