	...
	Check and share your telco experience with every one'!!}</h2>
		...
		<div class="row mt-5">
			<div class="col-12 my-5">
				<div class="find-service-section mx-auto text-center">
					@if(!\Session::get('locale') || (\Session::get('locale') && \Session::get('locale') == "en"))
						<iframe style="width: 80%" height="500" src="{{$homeContent ? $homeContent->section_five : ''}}?rel=0" frameborder="0" allow="accelerometer; autoplay;" allowfullscreen></iframe>
					@else
						<iframe style="width: 80%" height="500" src="{{$homeContent ? $homeContent->section_five_fr : ''}}?rel=0" frameborder="0" allow="accelerometer; autoplay;" allowfullscreen></iframe>
					@endif
								...
								<div class="poster">
									...
									<div class="detail">
										...
										<div class="blog-footer  px-2">
											<small>
											{{html_entity_decode(strip_tags($blog->blog_content))}}
											</small>
										</div>
									</div>
								</div>
