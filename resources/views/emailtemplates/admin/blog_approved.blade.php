                ...
                <tbody>
                  <tr>
                    <td class="inner contents center" style="padding-top:15px;padding-bottom:15px;padding-right:30px;padding-left:30px;text-align:left;">
                      <center>
                        <p class="h1 center" style="Margin:0;text-align:center;font-family:'flama-condensed','Arial Narrow',Arial;font-weight:100;font-size:30px;Margin-bottom:26px;">Your <b><i>{{$emaildata['blog_title']}}</i></b> artical has been published by admin </p>
                        ...
                        <p class="description center" style="font-family:'Muli','Arial Narrow',Arial;Margin:0;text-align:center;max-width:320px;color:#a1a8ad;line-height:24px;font-size:15px;Margin-bottom:10px;margin-left: auto; margin-right: auto;">
                            <a href="{{url('single-blog')}}/{{base64_encode($emaildata['blog_id'])}}">{{url('single-blog')}}/{{base64_encode($emaildata['blog_id'])}}</a>
                        </p>
