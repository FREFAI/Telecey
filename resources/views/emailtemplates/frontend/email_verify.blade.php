                                        ...
                                        <tbody>
                                            <tr>
                                                <td align="center" style="padding: 30px 56px 28px 56px;" valign="top">
                                                    <a style="color: #3498DB; text-decoration: none;"><img style="width: 30%; border: 0;" alt="Email verification" src="{{URL::asset('frontend/assets/img/logo-new.png')}}">
                                                    </a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" style="padding: 0 56px 28px 56px;" valign="top">
                                                    <div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 20px; color: #333;"><strong> Hi {{$emaildata['name']}}</strong> </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" style="padding: 0 56px 28px 56px;" valign="top">
                                                    <div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 20px; color: #333;">Thank you so much for joining us you just need to confirm that we got your email right. </div>
                                                </td>
                                            </tr>
                                            <tr>
