                                        ...
                                        <tbody>
                                            <tr>
                                                <td align="center" style="padding: 30px 56px 28px 56px;" valign="top">
                                                    <a style="color: #3498DB; text-decoration: none;"><img style="width: 30%; border: 0;" alt="New ticket" src="{{URL::asset('frontend/assets/img/logo-new.png')}}">
                                                    </a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0 56px 15px 56px;" valign="top">
                                                    <div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 20px; color: #333;"><strong> Hi {{$caseData['name']}},</strong> </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0 56px 15px 56px;" valign="top">
                                                    <div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 17px; color: #333; font-weight:500;">You have received a new message from telecey.</div>
                                                </td>
                                            </tr>
