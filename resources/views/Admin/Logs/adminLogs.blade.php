...
@section('title', 'Admin | Admin Logs list')
@section('content')
	        ...
	        <div class="card shadow">
	          <div class="card-header bg-transparent">
		    	<div class="row align-items-center">
                    ...
                    <div class="col-md-3">
                    <h5 class="heading-small text-muted mb-4">Admin Transaction</h5>
                    </div>
                       ...
                       <tr>
                           ...
                           <td class="text-center">
                                @if($log->request_type == 1)
                                    {{ $log->reuqest_param_name }}
                                @else
                                    -
                                @endif
                           </td>
                           <td class="text-center">
                                @if($log->request_type == 2)
                                    {{ $log->reuqest_param_name }}
                                @else
                                    -
                                @endif
                           ...
                           <td class="text-center">
                                <span class="badge badge-dot mr-4">
                                @if($log->appr_disapp_status !== null)
                                    @if($log->appr_disapp_status == 1)
                                    <span class="approved_ms"><i class="bg-success"></i> Approved</span>
                                    @else
                                    <span class="not_ap_ms"><i class="bg-danger"></i> Not approved</span>
                                    @endif
