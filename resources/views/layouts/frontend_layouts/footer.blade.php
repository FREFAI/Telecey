                ...
                <div class="col-lg-2 col-md-2 col-xs-6 col-mb-12">
                    <div class="widget">
                        <ul class="menu">
                            ...
                            <li><a href="/#how-does-it-work">{{__('footer.how_dose')}}</a></li>
                            <li><a href="/#our-information">{{__('footer.how_do')}}</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="site-info text-right footer-res">
                        <div class="footer-social mt-2">
                            ...
                            <a href="https://www.reddit.com/user/Telecey" class="link twitter"><span class="fa fa-reddit-alien"></span></a>
                            <a href="https://www.pinterest.ca/telecey" class="link twitter"><span class="fa fa fa-pinterest"></span></a>
                        </div>
                    </div>
                </div>
            </div>
