    	...
    	<div class="col-xl-12 mb-5 mb-xl-0">
	        <div class="card shadow">
	          <div class="card-header bg-transparent">
		    	<div class="row">
            <div class="col-md-6">
                <h5 class="heading-small text-muted mb-4">Add Category</h5>
            </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                          <div class="form-group">
                              <input value="{{old('category_name')}}" type="text" maxlength="100" class="form-control" placeholder="Category name" name="category_name" required>
                          </div>
                      </div>
