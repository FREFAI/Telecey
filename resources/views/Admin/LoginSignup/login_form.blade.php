        ...
        <div class="col-lg-5 col-md-7">
          ...
          <div class="row mt-3">
            ...
            <div class="col-6 text-right">
              <a href="{{url('/admin/signup')}}" class="text-light"><small>Create new account</small></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row align-items-center justify-content-xl-between">
        <div class="col-xl-6">
          <div class="copyright text-center text-xl-left text-muted">
            &copy; {{date('Y')}} <a href="javascript:void(0);" class="font-weight-bold ml-1" target="_blank">Telco Tales</a>
          </div>
        </div>
        <div class="col-xl-6">
          <ul class="nav nav-footer justify-content-center justify-content-xl-end">
            <li class="nav-item">
              <a href="javascript:void(0);" class="nav-link" target="_blank">Telco Tales</a>
            </li>
            <li class="nav-item">
